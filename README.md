...
A simple web application for reviewing GeoJSON features with map visualization and evaluation capabilities. Features are stored locally in IndexedDB, allowing you to evaluate each feature as "good" or "bad" with optional comments.
...
- Evaluate features as "good" or "bad" with optional comments
...
3. Evaluate each feature using the Good/Bad buttons
